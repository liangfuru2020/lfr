...
class CrawlWeibo:
    ...
    def getContent(self, id, max_page, startDate, endDate, csv_filename1,csv_filename2):
        ...
        f = open('C:\\Users\\hp\\Desktop\\weibo\\weibo.txt',mode='w',encoding='utf-8')
            ...
            for card in list_cards:
                if card['card_type']==9:# 过滤出微博，card_type=9的是微博card，card_type=11的是推荐有趣的人
                    ...
                    if create_date >= start_date and create_date <= end_date:
                        ...
                        zhuanfa2 = str(zhuanfa)
                        pinglun2 = str(pinglun)
                        #dianzhan2 = str(dianzhan+'\n')
                        dianzhan2 = str(dianzhan)
                        dianzhan2 = (dianzhan2+'\n')
                        content_list2 = [create_time,",",content,",",zhuanfa2,",",pinglun2,",",dianzhan2]
                        f.writelines(content_list2)
